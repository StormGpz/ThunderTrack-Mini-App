  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      final trade = Trade(
        ...
        fees: _totalValue * 0.001, // 0.1% 手续费
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Icon(
                    _selectedType == TradeType.buy ? Icons.trending_up : Icons.trending_down,
                    color: _selectedType == TradeType.buy ? Colors.green : Colors.red,
                  ),
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: _selectedType == TradeType.buy ? Colors.red : Colors.green,
                      ),
                    ),
                  ],
                ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _selectedType == TradeType.buy ? Colors.green : Colors.red,
                    foregroundColor: Colors.white,
                    padding: const EdgeInsets.symmetric(vertical: 16),
                  ),
                  child: Text(
                    _selectedType == TradeType.buy ? '记录买入交易' : '记录卖出交易',
